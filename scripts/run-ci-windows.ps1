...
function Run-Test {
    ...
    try {
        ctest -C Release --output-on-failure `
            -R "test_ent_init|test_ent_msg|test_utl_dll|test_utl_thread|test_utl_lock_cv|test_ent_thread|test_ent_thread_failures|test_utl_tpool|test_utl_tpool_lifecycle|test_utl_timer|test_utl_socket|test_ent_db|test_ent_log|test_ent_shm|test_security"
    }
    finally {
        Pop-Location
    }
